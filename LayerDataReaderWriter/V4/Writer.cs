...
{
    /// <summary>
    /// Represent a Layer data writer version 4.
    /// </summary>
    public class WriterV4 : IWriter
    {
        /// <summary>
        /// Gets 4.
        /// </summary>
        ...
        private void WriteLayerBlock(LayerBlock layerBlock, BinaryWriter writer)
        {
            ...
            byte flags = (byte)layerBlock.Flags.Select((b, i) => b ? (1 << i) : 0).Aggregate((a, b) => a + b);
            writer.Write(flags);
        ...
        /// <summary>
        /// Writes Layer data version 4 to a BinaryWriter.
        /// </summary>
        /// <param name="data">The version 4 data structure to write.</param>

...
namespace LayerDataReaderWriter.V8
{
    ...
    public struct LayerBlockElement
    {
        ...
        public LayerBlockElement(ushort id, float tx, float ty, float px, float py, float angle, float sx, float sy, byte type, ColliderType colliderType, params Component[] components)
            : this()
        {
            ID = id;
            Tx = tx;

...
{
    /// <summary>
    /// Represent a Layer data reader version 3.
    /// </summary>
    public class ReaderV3 : IReader
    {
        /// <summary>
        /// Gets 3.
        /// </summary>
        ...
        /// <summary>
        /// Reads Layer data version 3 from a BinaryReader.
        /// </summary>
        /// <param name="reader">The BinaryReader to read data from.</param>
        /// <returns>Returns a version 3 Layer data structure.</returns>

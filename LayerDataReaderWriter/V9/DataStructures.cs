...
namespace LayerDataReaderWriter.V9
{
    /// <summary>
    /// Defines the type (shape) of a collider for a given block element.
    /// </summary>
    ...
    /// </summary>
    public class LayerBlockElement
    {
        /// <summary>
        ...
        /// <param name="depth">The depth order.</param>
        ...
        public LayerBlockElement(ushort id, float tx, float ty, byte layer, byte depth, float px, float py, float angle, float sx, float sy, ushort type, ColliderType colliderType, params Component[] components)
        {
            ID = id;
            Tx = tx;
            Ty = ty;

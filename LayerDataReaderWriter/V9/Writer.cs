...
{
    /// <summary>
    /// Represent a Layer data writer version 9.
    /// </summary>
    public class WriterV9 : IWriter
    {
        /// <summary>
        /// Gets 9.
        /// </summary>
        ...
        private void WriteLayerBlockElement(BinaryWriter bw, LayerBlockElement element)
        {
            ...
            bw.Write(element.Tx);
            bw.Write(element.Ty);
            bw.Write(element.Layer);
            bw.Write(element.Depth);
            bw.Write(element.Px);
            bw.Write(element.Py);
        ...
        /// <summary>
        /// Writes LayerFile data version 9 to a BinaryWriter.
        /// </summary>
        /// <param name="data">The version 9 data structure to write.</param>

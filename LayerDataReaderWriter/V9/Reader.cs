...
{
    /// <summary>
    /// Represent a Layer data reader version 9.
    /// </summary>
    public class ReaderV9 : IReader
    {
        /// <summary>
        /// Gets 9.
        /// </summary>
        ...
        private LayerBlockElement ReadLayerBlockElement(BinaryReader reader)
        {
            return new LayerBlockElement(
                ...
                (ColliderType)reader.ReadByte(), // collider type
        ...
        /// <summary>
        /// Reads Layer data version 9 from a BinaryReader.
        /// </summary>
        /// <param name="reader">The BinaryReader to read data from.</param>
        /// <returns>Returns a version 9 LayerFile data structure.</returns>

...
{
    [TestClass]
    public class UnitTestV3
    {
        [TestMethod]
        public void TestWriter01()
        {
            var writer = new WriterV3();
        ...
        {
            var writer = new WriterV3();
            Assert.AreEqual(writer.Version, 3u);
        }
        ...
        public void TestWriter03()
        {
            ...
            var layerBlocks = new LayerBlock[]
            {
                new LayerBlock(0, 1, 10.0f, 90.0f, true, false,
                    ...
                    {
                        new LayerBlockElement(0, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.BoostLv01, null),
                        new LayerBlockElement(1, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.BoostLv02,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(2, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.BoostLv03,
                            new Component[]
                            {
                ...
                new LayerBlock(1, 2, 100.0f, 900.0f, false, true,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(3, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.GemBlue, null),
                        new LayerBlockElement(4, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.GemPurple,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(5, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.ObstacleBreakable,
                            new Component[]
                            {
        ...
        public void TestWriter04()
        {
            ...
            var layerBlocks = new LayerBlock[]
            {
                new LayerBlock(0, 1, 20.0f, 180.0f, false, true,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(10, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.BoostLv03,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(20, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.GemPurple,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(30, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.GemRed,
                            new Component[]
                            {
                ...
                new LayerBlock(1, 2, 200.0f, 1800.0f, true, false,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(40, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.ObstacleBreakable,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(50, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.ObstacleStatic,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(60, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.BoostLv01,
                            new Component[]
                            {
        ...
        {
            var reader = new ReaderV3();
            Assert.AreEqual(reader.Version, 3u);
        }
        ...
        public void TestReader03()
        {
            var layerBlocks1 = new LayerBlock[]
            {
                new LayerBlock(0, 1, 30.0f, 270.0f, false, true,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(100, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.BoostLv01,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(200, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.BoostLv02,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(300, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.BoostLv03,
                            new Component[]
                            {
                ...
                new LayerBlock(1, 2, 300.0f, 2700.0f, true, false,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(400, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.GemBlue,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(500, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.GemPurple,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(600, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.ObstacleBreakable,
                            new Component[]
                            {
            ...
            ReaderWriterManager.Write(layerBlocks1, stream, Encoding.UTF8, 3);
        ...
        public void TestReader04()
        {
            var layerBlocks1 = new LayerBlock[]
            {
                new LayerBlock(0, 1, 1000.0f, 9000.0f, true, false,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(1000, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.BoostLv01, new Component[0]),
                        new LayerBlockElement(2000, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.BoostLv02,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(3000, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.BoostLv03,
                            new Component[]
                            {
                ...
                new LayerBlock(1, 2, 1000.0f, 9000.0f, false, true,
                    new LayerBlockElement[]
                    {
                        new LayerBlockElement(4000, 0.1f, 2.3f, 4.5f, 6.7f, 8.9f, LayerBlockElementType.GemBlue,
                            new Component[]
                            {
                        ...
                        new LayerBlockElement(5000, 2.3f, 4.5f, 6.7f, 8.9f, 0.1f, LayerBlockElementType.GemPurple, new Component[0]),
                        new LayerBlockElement(6000, 4.5f, 6.7f, 8.9f, 0.1f, 2.3f, LayerBlockElementType.ObstacleBreakable,
                            new Component[]
                            {
                                new Component("TypeEnMousse28", NextComponentProperty()),

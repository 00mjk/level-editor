...
{
    [TestClass]
    public class UnitTestV6
    {
        [TestMethod]
        public void TestWriter01()
        {
            var writer = new WriterV6();
        ...
        {
            var writer = new WriterV6();
            Assert.AreEqual(writer.Version, 6u);
        }
        ...
        {
            var reader = new ReaderV6();
            Assert.AreEqual(reader.Version, 6u);
        }
        ...
        public void TestReader03()
        {
            ...
            ReaderWriterManager.Write(layerBlocks1, stream, Encoding.UTF8, 6);

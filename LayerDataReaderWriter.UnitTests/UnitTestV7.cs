...
{
    [TestClass]
    public class UnitTestV7
    {
        [TestMethod]
        public void TestWriter01()
        {
            var writer = new WriterV7();
        ...
        {
            var writer = new WriterV7();
            Assert.AreEqual(writer.Version, 7u);
        }
        ...
        {
            var reader = new ReaderV7();
            Assert.AreEqual(reader.Version, 7u);
        }
        ...
        public void TestReader03()
        {
            ...
            ReaderWriterManager.Write(file1, stream, Encoding.UTF8, 7);

...
namespace LayerDataReaderWriter.UnitTests
{
    ...
    public class UnitTestV9
    {
        ...
        {
            var writer = new WriterV9();
            Assert.AreEqual(writer.Version, 9u);
        }
        ...
        public void TestWriter03()
        {
            ...
            var layerBlocks = new LayerBlock[]
            {
                new LayerBlock(0, 1, 10.0f, 90.0f, new[] { true, false, true, false, true, false, true, false, true, false, true }, new SystemFlags(true),
                    new LayerBlockElement(0, 0.1f, 2.3f, 3, 0, 0.25f, 0.75f, 4.5f, 6.7f, 8.9f, 1, ColliderType.Circle, null),
                    new LayerBlockElement(1, 2.3f, 4.5f, 254, 255, 0.75f, 0.25f, 6.7f, 8.9f, 0.1f, 2, ColliderType.Square,
                        new Component("A", new ComponentProperty(null, true)),
                        new Component("B", new ComponentProperty("", false))
                    ),
                    new LayerBlockElement(2, 4.5f, 6.7f, 12, 128, 0.5f, 1.0f, 8.9f, 0.1f, 2.3f, 3, ColliderType.None,
                ...
                new LayerBlock(1, 2, 100.0f, 900.0f, new[] { false, true, false, true, false, true, false, true, false, true, false, false, false, false, true }, new SystemFlags(false),
                    new LayerBlockElement(3, 0.1f, 2.3f, 18, 31, 0.0f, 0.5f, 4.5f, 6.7f, 8.9f, 4, ColliderType.Square, null),
                    new LayerBlockElement(4, 2.3f, 4.5f, 255, 51, 0.1f, 0.9f, 6.7f, 8.9f, 0.1f, 5, ColliderType.Circle,
                    ...
                    new LayerBlockElement(5, 4.5f, 6.7f, 128, 237, 0.9f, 0.1f, 8.9f, 0.1f, 2.3f, 6, ColliderType.Circle,
            ...
            Assert.AreEqual(sr.ReadByte(), 3); // layer
            Assert.AreEqual(sr.ReadByte(), 0); // depth
            ...
            Assert.AreEqual(sr.ReadUInt16(), 1); // type
            ...
            Assert.AreEqual(sr.ReadByte(), 254); // layer
            Assert.AreEqual(sr.ReadByte(), 255); // depth
            ...
            Assert.AreEqual(sr.ReadUInt16(), 2); // type
            ...
            Assert.AreEqual(sr.ReadByte(), 12); // layer
            Assert.AreEqual(sr.ReadByte(), 128); // depth
            ...
            Assert.AreEqual(sr.ReadUInt16(), 3); // type
            ...
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // tx
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // ty
            Assert.AreEqual(sr.ReadByte(), 18); // layer
            Assert.AreEqual(sr.ReadByte(), 31); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.0f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.5f); // py
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // angle
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // sx
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // sy
            Assert.AreEqual(sr.ReadUInt16(), 4); // type
            Assert.AreEqual(sr.ReadByte(), 1); // collider type
            Assert.AreEqual(sr.ReadByte(), 0); // number of components
            ...
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // tx
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // ty
            Assert.AreEqual(sr.ReadByte(), 255); // layer
            Assert.AreEqual(sr.ReadByte(), 51); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.9f); // py
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // angle
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // sx
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // sy
            Assert.AreEqual(sr.ReadUInt16(), 5); // type
            Assert.AreEqual(sr.ReadByte(), 2); // collider type
            ...
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // tx
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // ty
            Assert.AreEqual(sr.ReadByte(), 128); // layer
            Assert.AreEqual(sr.ReadByte(), 237); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.9f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // py
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // angle
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // sx
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // sy
            Assert.AreEqual(sr.ReadUInt16(), 6); // type
            Assert.AreEqual(sr.ReadByte(), 2); // collider type
            Assert.AreEqual(sr.ReadByte(), 3); // number of components
        ...
        public void TestWriter04()
        {
            ...
            var layerBlocks = new LayerBlock[]
            {
                new LayerBlock(0, 1, 20.0f, 180.0f, new[] { false, true, true, false, true, false, false, true, true }, new SystemFlags(false),
                    new LayerBlockElement(10, 0.1f, 2.3f, 37, 64, 0.8f, 0.2f, 4.5f, 6.7f, 8.9f, 3, ColliderType.Circle,
                        new Component("Type1", new ComponentProperty(null, false)),
                        new Component("Type2", null)
                    ),
                    new LayerBlockElement(20, 2.3f, 4.5f, 48, 87, 0.1f, 0.2f, 6.7f, 8.9f, 0.1f, 4, ColliderType.Square,
                        new Component("Type3", new ComponentProperty("", -37)),
                        new Component("Type4", new ComponentProperty("v1", 51))
                    ),
                    new LayerBlockElement(30, 4.5f, 6.7f, 234, 91, 0.3f, 0.7f, 8.9f, 0.1f, 2.3f, 5, ColliderType.Circle,
                ...
                new LayerBlock(1, 2, 200.0f, 1800.0f, new[] { true, false, false, true, false, true, true, false, false }, new SystemFlags(true),
                    new LayerBlockElement(40, 0.1f, 2.3f, 194, 247, 0.25f, 0.75f, 4.5f, 6.7f, 8.9f, 6, ColliderType.None,
                        new Component("Type7", new ComponentProperty(null, "Type7")),
                        new Component("Type8", new ComponentProperty("", "Type8"))
                    ),
                    new LayerBlockElement(50, 2.3f, 4.5f, 99, 1, 0.75f, 0.25f, 6.7f, 8.9f, 0.1f, 7, ColliderType.Circle,
                        new Component("Type9", new ComponentProperty("v4", null)),
                        new Component("Type10", new ComponentProperty("v5", ""))
                    ),
                    new LayerBlockElement(60, 4.5f, 6.7f, 101, 199, 0.5f, 0.5f, 8.9f, 0.1f, 2.3f, 8, ColliderType.Square,
            ...
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // tx
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // ty
            Assert.AreEqual(sr.ReadByte(), 37); // layer
            Assert.AreEqual(sr.ReadByte(), 64); // depth
            ...
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // tx
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // ty
            Assert.AreEqual(sr.ReadByte(), 48); // layer
            Assert.AreEqual(sr.ReadByte(), 87); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.2f); // py
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // angle
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // sx
            ...
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // tx
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // ty
            Assert.AreEqual(sr.ReadByte(), 234); // layer
            Assert.AreEqual(sr.ReadByte(), 91); // depth
            ...
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // tx
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // ty
            Assert.AreEqual(sr.ReadByte(), 194); // layer
            Assert.AreEqual(sr.ReadByte(), 247); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.25f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.75f); // py
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // angle
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // sx
            ...
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // tx
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // ty
            Assert.AreEqual(sr.ReadByte(), 99); // layer
            Assert.AreEqual(sr.ReadByte(), 1); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.75f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.25f); // py
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // angle
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // sx
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // sy
            Assert.AreEqual(sr.ReadUInt16(), 7); // type
            Assert.AreEqual(sr.ReadByte(), 2); // collider type
            Assert.AreEqual(sr.ReadByte(), 2); // number of components
            ...
            Assert.AreEqual(sr.ReadSingle(), 4.5f); // tx
            Assert.AreEqual(sr.ReadSingle(), 6.7f); // ty
            Assert.AreEqual(sr.ReadByte(), 101); // layer
            Assert.AreEqual(sr.ReadByte(), 199); // depth
            Assert.AreEqual(sr.ReadSingle(), 0.5f); // px
            Assert.AreEqual(sr.ReadSingle(), 0.5f); // py
            Assert.AreEqual(sr.ReadSingle(), 8.9f); // angle
            Assert.AreEqual(sr.ReadSingle(), 0.1f); // sx
            Assert.AreEqual(sr.ReadSingle(), 2.3f); // sy
            Assert.AreEqual(sr.ReadUInt16(), 8); // type
            Assert.AreEqual(sr.ReadByte(), 1); // collider type
            Assert.AreEqual(sr.ReadByte(), 2); // number of components
        ...
        {
            var reader = new ReaderV9();
            Assert.AreEqual(reader.Version, 9u);
        }
        ...
        public void TestReader03()
        {
            var layerBlocks1 = new LayerBlock[]
            {
                new LayerBlock(0, 1, 30.0f, 270.0f, Enumerable.Range(0, 35).Select(i => NextBool()).ToArray(), new SystemFlags(NextBool()),
                    new LayerBlockElement(100, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                    ...
                    new LayerBlockElement(200, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                    ...
                    new LayerBlockElement(300, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                ...
                new LayerBlock(1, 2, 300.0f, 2700.0f, Enumerable.Range(0, 35).Select(i => NextBool()).ToArray(), new SystemFlags(NextBool()),
                    new LayerBlockElement(400, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), null),
                        new Component(NextString(), new ComponentProperty(null, NextBool())),
                        new Component(NextString(), new ComponentProperty("", NextGuid())),
                    ...
                    new LayerBlockElement(500, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), new ComponentProperty(null, NextBool())),
                    ...
                    new LayerBlockElement(600, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), new ComponentProperty(null, NextGuid())),
            ...
            ReaderWriterManager.Write(file1, stream, Encoding.UTF8, 9);
            ...
            for (int b = 0; b < layerBlocks1.Length; b++)
            {
                ...
                for (int e = 0; e < layerBlocks1[b].Elements.Length; e++)
                {
                    ...
                    Assert.AreEqual(layerBlocks1[b].Elements[e].Layer, layerBlocks2[b].Elements[e].Layer); // layer
                    Assert.AreEqual(layerBlocks1[b].Elements[e].Depth, layerBlocks2[b].Elements[e].Depth); // depth
        ...
        public void TestReader04()
        {
            var layerBlocks1 = new LayerBlock[]
            {
                new LayerBlock(0, 1, 1000.0f, 9000.0f, Enumerable.Range(0, 35).Select(i => NextBool()).ToArray(), new SystemFlags(NextBool()),
                    new LayerBlockElement(1000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(), new Component[0]),
                    new LayerBlockElement(2000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                    ...
                    new LayerBlockElement(3000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                ...
                new LayerBlock(1, 2, 1000.0f, 9000.0f, Enumerable.Range(0, 35).Select(i => NextBool()).ToArray(), new SystemFlags(NextBool()),
                    new LayerBlockElement(4000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                    ...
                    new LayerBlockElement(5000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(), new Component[0]),
                    new LayerBlockElement(6000, NextFloat(), NextFloat(), NextByte(), NextByte(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextFloat(), NextByte(), NextColliderType(),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
                        new Component(NextString(), NextComponentProperty()),
